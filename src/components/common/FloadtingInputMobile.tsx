  ...
  return (
    <div className={`relative w-full ${className}`}>
      <input
        ...
        className={`w-full ${heightClass} ${roundedClass} ${bgClass} border border-white/30 ${
          isFocused ? "border-[#424d5e] border-2 ring-1 ring-[#424d5e]" : borderClass
      ...
      <label
        ...
        className={`absolute left-3.5 pointer-events-none font-semibold transition-all duration-150 ease-out origin-left select-none truncate max-w-[calc(100%-28px)] ${
          isFloating
            ? "top-[6px] translate-y-0 text-[15px] text-gray-400"
